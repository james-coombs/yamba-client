  ...
  exports['default'] = _ember['default'].Component.extend({
    ...
    actions: {
      ...
      createPage: function createPage() {
        var newPage = new FormData(event.target); // Ember jQuery to find the form by it's id.
  ...
  exports['default'] = _ember['default'].Service.extend({
    ...
    newPageUpload: function newPageUpload(newPage) {
      return this.get('ajax').post('/pages', { // This will use the ajax service and allow us to send a post request to the `/pages` route on in API
        data: newPage, // The FormData object which we have called `newPage`
        contentType: false,
        processData: false
      });
    }
...
if (!runningTests) {
  require("wember_client/app")["default"].create({"name":"wember_client","version":"0.0.0+dda6900a"});
}
